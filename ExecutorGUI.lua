...
local function FXKHWS_fake_script() -- TextBox.LocalScript 
...
coroutine.wrap(FXKHWS_fake_script)()
local function FWKGIAL_fake_script() -- Execute.LocalScript 
...
coroutine.wrap(FWKGIAL_fake_script)()
local function YPQG_fake_script() -- Clear.LocalScript 
...
coroutine.wrap(YPQG_fake_script)()
local function FUWUX_fake_script() -- Main.LocalScript 
	local script = Instance.new('LocalScript', Main)

	script.Parent.Draggable = true
	script.Parent.Active = true
end
coroutine.wrap(FUWUX_fake_script)()
